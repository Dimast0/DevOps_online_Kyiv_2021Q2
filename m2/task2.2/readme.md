...
## 1-4. Firstly, I registered an AWS Free Tier account. Then I started an Amazon Linux VM with Amazon Lightsail and connected to it.


<p><img src="screenshots/1.png" width="800"/></p>

## 5.Launched another Linux VM without Amazon Lightsail. I used an instance of t2.micro and an Amazon Linux 2.0 operating system.

<p><img src="screenshots/2.png" width="800"/></p>
<p><img src="screenshots/3.png" width="800"/></p>

## 6.Then I created a snapshot of the EC2 VM.
